...
The current world is structured around optimization. it reward people who set clear goals, who [specialize](https://a7med7x7.github.io/posts/consenting_to_the_game_rules/#:~:text=I%20always%20think%20of%20the%20American%20Constitution), execute according to plan, and measure consistent progress. this model works extremely well for a certain type of person. it produces predictable growth. it rewards steady output. it creates visible success. it is what the economics want. but it fails badly for another type, the ones I am describing.
