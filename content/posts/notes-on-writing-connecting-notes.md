...
This is why linking matters. it transforms isolated thoughts into a network. it allows ideas to talk to each other across time. when you use a blog for personal writing, or when you write in markdown inside a tool like [Obsidian](https://obsidian.md/), the ability to connect notes creates an architecture for thinking. you stop collecting fragments and start constructing meaning.
