...
These questions are asked by almost all teenagers since the born of millenia, and they are meant to understand the world in order to make a decision, they are a "call" for data points to make a decision based on, but as you can see, most of these questions are dense, they are philosophical, hard to answer, not just for teenagers and people figuring out what to do in their lives, but even for the eldery, they are about meaning, existence, identity, things that you will naturally experience the moment you you're conscious, the moment you're born, others might require you to explore politics and economics, to get an optimal answer, what you need to do is simple, first is to just believe in the idea of making tomorrow a better day, to reduce your suffering. because this will help you in the pursuit of existential clarity, and will yield you with stamina to purse answers in different directions, this worth a standalone article, but the gist of what I'm trying is, if you want to find answers to the questions you are having, you need to be good with whatever will serve you in making tomorrow a better day, the same way you are good with the language, out of its importance in describing the universe, you need to be good and welcome with the things that will minimize the complexity of your situations, having an initial faith you will be facing the game rules (The nonsense you don't understand) and use it as instrument for better you. if this might still abstract I might indeed to write a standalone point, but in a nutshell, the first thing is to say, I will play,
