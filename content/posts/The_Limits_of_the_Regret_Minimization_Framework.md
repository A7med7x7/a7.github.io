...
tags = ['decision making', 'reflection', 'frameworks']
...
Maybe I expected too much from this method,or misused it,but that’s not really the point I want to highlight.
Perhaps this reflection doesn’t offer a grand piece of wisdom, but you can still take something from it: explore new ways of making decisions in your own life. Experiment with frameworks or tactics that help you choose the optimal option more often.
And most importantly, pick an option, don’t stay up until *(3:42 AM)* like me, still undecided and unable to sleep.
