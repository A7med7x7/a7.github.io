...
{{< tweet user="mr_ntropy" id="1975473211094552821" >}}
...
![](https://youtu.be/fj0hpsJvrko?si=n3bIe_NI9pyZsh2M)

{{< youtube n3bIe_NI9pyZsh2M >}}
...
What I did instead was keep moving. I would feel something unresolved at the end of a difficult period and then fill that space with more work, more busyness, anything to avoid sitting with the question of whether I handled it right. I have a debt — not financial, but experiential — of days that stretch back across a couple of years, where I deferred the processing entirely. not out of denial exactly, and not out of carelessness. I overthink small things compulsively, and the only way I've found to stay functional is to quarantine the larger ones and file them under _later_. the problem is that later always arrives.
